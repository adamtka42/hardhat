...
//   - src/internal/qrl/console-log-signatures.ts (decoder metadata)
...
function generateConsoleLibrary() {
  ...
  const consoleHyp =
    ...
    `// src/internal/qrl/console-log-signatures.ts comes from the same run.\n` +
    `//\n` +
...
if (require.main === module) {
  ...
  console.error(
    `console-library-generator: wrote console.hyp and console-log-signatures.ts`
  );
}
